...
if (Input::exists() && Input::get("action") == "nodes") {
    ...
    if (Input::exists() && Input::get("action") == "edit_node") {
        if (Token::check(Input::get("token"))) {
            ...
            if ($validation->passed()) {
                $pwfield = _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("password"));
                if (!empty($pwfield) && isset($pwfield)) {
                    $db->update("vncp_nodes", _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("nid")), ["username" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("username")), "password" => _obfuscated_0D1A2A3B0501041909311C2D0A3D2A1D290304395C0A01_(_obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("password"))), "realm" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("realm")), "port" => (int) _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("port")), "location" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("location")), "asn" => "11111", "cpu" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("cpu")), "mailing_enabled" => 0, "backup_store" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("backup"))]);
                } else {
                    $db->update("vncp_nodes", _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("nid")), ["username" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("username")), "realm" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("realm")), "port" => (int) _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("port")), "location" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("location")), "asn" => "11111", "cpu" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("cpu")), "mailing_enabled" => 0, "backup_store" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("backup"))]);
                }
                $log->log("Edited node " . _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("nid")), "admin", 0, $user->data()->username, $_SERVER["REMOTE_ADDR"]);
        ...
        if (Input::exists() && Input::get("action") == "users" && Input::get("form_name") == "new_user_form") {
            ...
            if ($validation->passed()) {
                ...
                $default_language = _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_($db->get("vncp_settings", ["item", "=", "default_language"])->first()->value);
                    ...
                    if (Input::exists() && Input::get("action") == "settings" && Input::get("whatform") == "general_settings") {
                        ...
                        if (Input::exists() && Input::get("action") == "settings" && Input::get("whatform") == "mail_settings") {
                            if (Token::check(Input::get("token"))) {
                                ...
                                if ($validation->passed()) {
                                    $db->update("vncp_settings", 22, ["value" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("from_email_addr"))]);
                                    $db->update("vncp_settings", 40, ["value" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("mail_type"))]);
                                    $db->update("vncp_settings", 34, ["value" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("from_email_addr_name"))]);
                                    $db->update("vncp_settings", 35, ["value" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("smtp_host"))]);
                                    $db->update("vncp_settings", 36, ["value" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("smtp_port"))]);
                                    $db->update("vncp_settings", 37, ["value" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("smtp_username"))]);
                                    ...
                                    $db->update("vncp_settings", 39, ["value" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("smtp_type"))]);
                                ...
                                if (Token::check(Input::get("token"))) {
                                    ...
                                    if ($validation->passed()) {
                                        if (isset($_POST["natunderstand"])) {
                                            $check1 = $db->get("vncp_nodes", ["name", "=", _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("natnode"))])->all();
                                            $check2 = $db->get("vncp_tuntap", ["node", "=", _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("natnode"))])->all();
                                            if (count($check1) == 1 && count($check2) == 1) {
                                                $checkResolve = gethostbyname($check1[0]->hostname);
                                                if ($checkResolve == _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("natnodeip"))) {
                                                    $cidr = explode("/", _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("natiprange")));
                                                    if (count($cidr) == 2) {
                                                        $cidr = (int) $cidr[1];
                                                        $lastoctet = (int) substr(explode("/", _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("natiprange")))[0], -1);
                                                        if (24 < $cidr || $cidr < 16 || $lastoctet != 0) {
                                                            $errors = "NAT IP Range must be between a /24 and a /16. The last octet must also be 0.";
                                                        } else {
                                                            $natrange = explode(".", explode("/", _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("natiprange")))[0]);
                                                            if (count($natrange) == 4) {
                                                                            ...
                                                                            switch ($cidr) {
                                                                                ...
                                                                                default:
                                                                                    ...
                                                                                    if (!$ssh->login("root", _obfuscated_0D3C343005103213271D5C5B292F3D1D3D113836105B11_($check2[0]->password))) {
                                                                                        $log->log("Could not SSH to NAT node " . _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("natnode")), "error", 1, $user->data()->username, $_SERVER["REMOTE_ADDR"]);
                                                                                        $errors = "Could not SSH to NAT node.";
                                                                                    } else {
                                                                                        $ssh->exec("echo \"" . $interfacesTemplate . "\" >> /etc/network/interfaces");
                                                                                        $ssh->exec("iptables -t nat -A POSTROUTING -s '" . _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("natiprange")) . "' -o vmbr0 -j MASQUERADE");
                                                                                        ...
                                                                                        $ssh->disconnect();
                                                                                        $db->insert("vncp_nat", ["node" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("natnode")), "publicip" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("natnodeip")), "natcidr" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("natiprange")), "natnetmask" => $natnetmask, "vmlimit" => $limit]);
                                                                                        $log->log("Enabled NAT on node " . _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("natnode")), "admin", 0, $user->data()->username, $_SERVER["REMOTE_ADDR"]);
                                    ...
                                    if (Token::check(Input::get("token"))) {
                                        ...
                                        if ($validation->passed()) {
                                            if (Input::get("node") != "default" && Input::get("osfriendly") != "default" && Input::get("storage_location") != "default" && Input::get("ostype") != "default" && Input::get("userid") != "default" && Input::get("lxcisnat") != "default") {
                                                $users_results = $db->get("vncp_users", ["id", "=", _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("userid"))]);
                                                $users_results = $users_results->all();
                                                if (count($users_results) == 1) {
                                                    $lxcisnat = _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("lxcisnat"));
                                                    $natpublicports = _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("natpublicports"));
                                                    $natdomainproxy = _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("natdomainproxy"));
                                                    if ($lxcisnat == "true") {
                                                        if (isset($natpublicports) && !empty($natpublicports) && 1 <= (int) $natpublicports && (int) $natpublicports <= 30) {
                                                            if (isset($natdomainproxy) && 0 <= (int) $natdomainproxy && (int) $natdomainproxy <= 15) {
                                                                $getNATCIDR = $db->get("vncp_nat", ["node", "=", _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("node"))])->all();
                                                                if (count($getNATCIDR) == 1) {
                                                                    $NATCIDR = $getNATCIDR[0]->natcidr;
                                                                    if (_obfuscated_0D1D160B191F262E1C10382E1A2808231A172828272201_(explode("/", _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("ipv4")))[0], $NATCIDR)) {
                                                                        $node_results = $db->get("vncp_nodes", ["name", "=", _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("node"))]);
                                                                        ...
                                                                        if (!$noLogin) {
                                                                            ...
                                                                            if (Input::get("setmacaddress")) {
                                                                                $saved_macaddr = strtoupper(_obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("setmacaddress")));
                                                                            } else {
                                                                                $saved_macaddr = MacAddress::generateMacAddress();
                                                                            }
                                                                            $newlxc = ["ostemplate" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("osfriendly")), "vmid" => (int) $getvmid, "cmode" => "tty", "cores" => (int) _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("cpucores")), "cpulimit" => 0, "cpuunits" => 1024, "description" => explode("/", _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("ipv4")))[0], "hostname" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("hostname")), "memory" => (int) _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("ram")), "onboot" => 0, "ostype" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("ostype")), "password" => $plaintext_password, "pool" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("poolid")), "protection" => 0, "rootfs" => "" . _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("storage_location")) . ":" . _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("storage_size")), "storage" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("storage_location")), "swap" => 512, "tty" => 2, "unprivileged" => 1];
                                                                            if (!Input::get("portspeed") || (int) _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("portspeed")) <= 0) {
                                                                                $newlxc["net0"] = "bridge=vmbr10,hwaddr=" . $saved_macaddr . ",ip=" . Input::get("ipv4") . ",gw=" . Input::get("ipv4gw") . ",ip6=auto,name=eth0,type=veth";
                                                                            } else {
                                                                                $newlxc["net0"] = "bridge=vmbr10,hwaddr=" . $saved_macaddr . ",ip=" . Input::get("ipv4") . ",gw=" . Input::get("ipv4gw") . ",ip6=auto,name=eth0,type=veth,rate=" . (string) _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("portspeed"));
                                                                            }
                                                                            ...
                                                                            if (!$createlxc) {
                                                                                ...
                                                                                $allow_backups = _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_($db->get("vncp_settings", ["item", "=", "enable_backups"])->first()->value);
                                                                                $abvalue = -1;
                                                                                ...
                                                                                $db->insert("vncp_lxc_ct", ["user_id" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("userid")), "node" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("node")), "os" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("ostype")), "hb_account_id" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("hb_account_id")), "pool_id" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("poolid")), "pool_password" => _obfuscated_0D1A2A3B0501041909311C2D0A3D2A1D290304395C0A01_($plaintext_password), "ip" => explode("/", Input::get("ipv4"))[0], "suspended" => 0, "allow_backups" => $abvalue, "fw_enabled_net0" => 0, "fw_enabled_net1" => 0, "has_net1" => 0, "tuntap" => 0, "onboot" => 0, "quotas" => 0]);
                                                                                $db->insert("vncp_ct_backups", ["userid" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("userid")), "hb_account_id" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("hb_account_id")), "backuplimit" => -1]);
                                                                                $today = new DateTime();
                                                                                $today->add(new DateInterval("P30D"));
                                                                                $reset_date = $today->format("Y-m-d 00:00:00");
                                                                                $db->insert("vncp_bandwidth_monitor", ["node" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("node")), "pool_id" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("poolid")), "hb_account_id" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("hb_account_id")), "ct_type" => "lxc", "current" => 0, "max" => (int) _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("bandwidth_limit")) * 1073741824, "reset_date" => $reset_date, "suspended" => 0]);
                                                                                $saved_network = explode(".", Input::get("ipv4gw"));
                                                                                list($dhcpip) = explode("/", _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("ipv4")));
                                                                                $saved_network = explode(".", _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("ipv4gw")));
                                                                                $db->insert("vncp_dhcp", ["mac_address" => $saved_macaddr, "ip" => $dhcpip, "gateway" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("ipv4gw")), "netmask" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("ipv4_netmask")), "network" => $saved_network[0] . "." . $saved_network[1] . "." . $saved_network[2] . "." . (string) ((int) $saved_network[3] - 1), "type" => 0]);
                                                                                $db->insert("vncp_natforwarding", ["user_id" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("userid")), "node" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("node")), "hb_account_id" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("hb_account_id")), "avail_ports" => (int) $natpublicports, "ports" => "", "avail_domains" => (int) $natdomainproxy, "domains" => ""]);
                                                                                $log->log("Created new NAT LXC " . $getvmid . " on node " . _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("node")), "admin", 0, $user->data()->username, $_SERVER["REMOTE_ADDR"]);
                                                        ...
                                                        if (!$noLogin) {
                                                            ...
                                                            if (!Input::get("portspeed") || (int) _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("portspeed")) <= 0) {
                                                                ...
                                                                $newlxc["net0"] = "bridge=vmbr0,hwaddr=" . $saved_macaddr . ",ip=" . Input::get("ipv4") . ",gw=" . Input::get("ipv4gw") . ",ip6=auto,name=eth0,type=veth,rate=" . (string) _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("portspeed"));
                                                            }
                                                            if (0 < (int) Input::get("setvlantag")) {
                                                                $newlxc["net0"] = $newlxc["net0"] . ",tag=" . (string) Input::get("setvlantag");
                                                            }
                                                            ...
                                                            if (!$createlxc) {
                                                                ...
                                                                $db->insert("vncp_lxc_ct", ["user_id" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("userid")), "node" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("node")), "os" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("ostype")), "hb_account_id" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("hb_account_id")), "pool_id" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("poolid")), "pool_password" => _obfuscated_0D1A2A3B0501041909311C2D0A3D2A1D290304395C0A01_($plaintext_password), "ip" => explode("/", _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("ipv4")))[0], "suspended" => 0, "allow_backups" => $abvalue, "fw_enabled_net0" => 0, "fw_enabled_net1" => 0, "has_net1" => 0, "tuntap" => 0, "onboot" => 0, "quotas" => 0]);
                                                                $db->insert("vncp_ct_backups", ["userid" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("userid")), "hb_account_id" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("hb_account_id")), "backuplimit" => -1]);
                                                                $today = new DateTime();
                                                                $today->add(new DateInterval("P30D"));
                                                                $reset_date = $today->format("Y-m-d 00:00:00");
                                                                $db->insert("vncp_bandwidth_monitor", ["node" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("node")), "pool_id" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("poolid")), "hb_account_id" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("hb_account_id")), "ct_type" => "lxc", "current" => 0, "max" => (int) _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("bandwidth_limit")) * 1073741824, "reset_date" => $reset_date, "suspended" => 0]);
                                                                $saved_network = explode(".", Input::get("ipv4gw"));
                                                                $db->insert("vncp_dhcp", ["mac_address" => $saved_macaddr, "ip" => explode("/", _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("ipv4")))[0], "gateway" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("ipv4gw")), "netmask" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("ipv4_netmask")), "network" => $saved_network[0] . "." . $saved_network[1] . "." . $saved_network[2] . "." . (string) ((int) $saved_network[3] - 1), "type" => 0]);
                                                                $log->log("Created new LXC " . $getvmid . " on node " . _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("node")), "admin", 0, $user->data()->username, $_SERVER["REMOTE_ADDR"]);
                                                                $lxcCreatedSuccess = true;
                                                            }
                                                        } else {
                                                            $errors = "Could not login to Proxmox node.";
                                            ...
                                            if ($validation->passed()) {
                                                if (Input::get("os_installation_type") == "iso") {
                                                    if (Input::get("node") != "default" && Input::get("osfriendly") != "default" && Input::get("storage_location") != "default" && Input::get("ostype") != "default" && Input::get("nicdriver") != "default" && Input::get("cputype") != "default" && Input::get("storage_driver") != "default" && Input::get("userid") != "default" && Input::get("kvmisnat") != "default") {
                                                        ...
                                                        $users_results = $users_results->all();
                                                        if (count($users_results) == 1) {
                                                            $kvmisnat = _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("kvmisnat"));
                                                            $natpublicports = _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("natpublicports"));
                                                            $natdomainproxy = _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("natdomainproxy"));
                                                            if ($kvmisnat == "true") {
                                                                if (isset($natpublicports) && !empty($natpublicports) && 1 <= (int) $natpublicports && (int) $natpublicports <= 30) {
                                                                    if (isset($natdomainproxy) && 0 <= (int) $natdomainproxy && (int) $natdomainproxy <= 15) {
                                                                        ...
                                                                        if (count($getNATCIDR) == 1) {
                                                                            $NATCIDR = $getNATCIDR[0]->natcidr;
                                                                            if (_obfuscated_0D1D160B191F262E1C10382E1A2808231A172828272201_(_obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("ipv4")), $NATCIDR)) {
                                                                                $node_results = $db->get("vncp_nodes", ["name", "=", _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("node"))]);
                                                                                $node_data = $node_results->first();
                                                                                $pxAPI = new PVE2_API($node_data->hostname, $node_data->username, $node_data->realm, _obfuscated_0D3C343005103213271D5C5B292F3D1D3D113836105B11_($node_data->password));
                                                                                $noLogin = false;
                                                                                ...
                                                                                if (!$noLogin) {
                                                                                    ...
                                                                                    $newvm = ["vmid" => (int) $getvmid, "agent" => 0, "acpi" => 1, "balloon" => (int) Input::get("ram"), "boot" => "cdn", "bootdisk" => $bootdisk, "cores" => (int) Input::get("cpucores"), "cpu" => Input::get("cputype"), "cpulimit" => "0", "cpuunits" => 1024, "description" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("ipv4")), "hotplug" => "1", "ide2" => Input::get("osfriendly") . ",media=cdrom", "kvm" => 1, "localtime" => 1, "memory" => (int) Input::get("ram"), "name" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("hostname")), "numa" => 0, "onboot" => 0, "ostype" => Input::get("ostype"), "pool" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("poolid")), "protection" => 0, "reboot" => 1, "sockets" => 1, "storage" => Input::get("storage_location"), "tablet" => 1, "template" => 0, "vga" => $vga];
                                                                                    if ((int) _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("portspeed")) <= 0) {
                                                                                        $newvm["net0"] = "bridge=vmbr10," . _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("nicdriver")) . "=" . $saved_macaddr;
                                                                                    } else {
                                                                                        $newvm["net0"] = "bridge=vmbr10," . _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("nicdriver")) . "=" . $saved_macaddr . ",rate=" . (string) _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("portspeed"));
                                                                                    }
                                                                                    if (0 < (int) Input::get("setvlantag")) {
                                                                                    ...
                                                                                    if (!$createkvm) {
                                                                                        ...
                                                                                        $db->insert("vncp_kvm_ct", ["user_id" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("userid")), "node" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("node")), "os" => explode("/", _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("osfriendly")))[1], "hb_account_id" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("hb_account_id")), "pool_id" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("poolid")), "pool_password" => _obfuscated_0D1A2A3B0501041909311C2D0A3D2A1D290304395C0A01_($plaintext_password), "ip" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("ipv4")), "suspended" => 0, "allow_backups" => $abvalue, "fw_enabled_net0" => 0, "fw_enabled_net1" => 0, "has_net1" => 0, "onboot" => 0, "cloud_account_id" => 0, "cloud_hostname" => "", "from_template" => 0]);
                                                                                        $db->insert("vncp_ct_backups", ["userid" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("userid")), "hb_account_id" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("hb_account_id")), "backuplimit" => -1]);
                                                                                        $today = new DateTime();
                                                                                        $today->add(new DateInterval("P30D"));
                                                                                        $reset_date = $today->format("Y-m-d 00:00:00");
                                                                                        $db->insert("vncp_bandwidth_monitor", ["node" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("node")), "pool_id" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("poolid")), "hb_account_id" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("hb_account_id")), "ct_type" => "qemu", "current" => 0, "max" => (int) _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("bandwidth_limit")) * 1073741824, "reset_date" => $reset_date, "suspended" => 0]);
                                                                                        ...
                                                                                        $db->insert("vncp_dhcp", ["mac_address" => $saved_macaddr, "ip" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("ipv4")), "gateway" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("ipv4_gateway")), "netmask" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("ipv4_netmask")), "network" => $saved_dhcp, "type" => 0]);
                                                                                        $db->insert("vncp_natforwarding", ["user_id" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("userid")), "node" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("node")), "hb_account_id" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("hb_account_id")), "avail_ports" => (int) $natpublicports, "ports" => "", "avail_domains" => (int) $natdomainproxy, "domains" => ""]);
                                                                                        ...
                                                                                        $log->log("Created new NAT KVM " . $getvmid . " on node " . _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("node")), "admin", 0, $user->data()->username, $_SERVER["REMOTE_ADDR"]);
                                                                ...
                                                                if (!$noLogin) {
                                                                    ...
                                                                    $newvm = ["vmid" => (int) $getvmid, "agent" => 0, "acpi" => 1, "balloon" => (int) Input::get("ram"), "boot" => "cdn", "bootdisk" => $bootdisk, "cores" => (int) Input::get("cpucores"), "cpu" => Input::get("cputype"), "cpulimit" => "0", "cpuunits" => 1024, "description" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("ipv4")), "hotplug" => "1", "ide2" => Input::get("osfriendly") . ",media=cdrom", "kvm" => 1, "localtime" => 1, "memory" => (int) Input::get("ram"), "name" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("hostname")), "numa" => 0, "onboot" => 0, "ostype" => Input::get("ostype"), "pool" => Input::get("poolid"), "protection" => 0, "reboot" => 1, "sockets" => 1, "storage" => Input::get("storage_location"), "tablet" => 1, "template" => 0, "vga" => $vga];
                                                                    if ((int) _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("portspeed")) <= 0) {
                                                                        $newvm["net0"] = "bridge=vmbr0," . _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("nicdriver")) . "=" . $saved_macaddr;
                                                                    } else {
                                                                        $newvm["net0"] = "bridge=vmbr0," . _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("nicdriver")) . "=" . $saved_macaddr . ",rate=" . (string) _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("portspeed"));
                                                                    }
                                                                    if (0 < (int) Input::get("setvlantag")) {
                                                                        $newvm["net0"] = $newvm["net0"] . ",tag=" . (string) Input::get("setvlantag");
                                                                    }
                                                                    ...
                                                                    if (!$createkvm) {
                                                                        ...
                                                                        $log->log("Created new KVM " . $getvmid . " on node " . _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("node")), "admin", 0, $user->data()->username, $_SERVER["REMOTE_ADDR"]);
                                                                        $kvmCreatedSuccess = true;
                                                                    }
                                                                } else {
                                                                    $errors = "Could not login to Proxmox node.";
                                                                            ...
                                                                            if (count($getNATCIDR) == 1) {
                                                                                ...
                                                                                if (_obfuscated_0D1D160B191F262E1C10382E1A2808231A172828272201_(_obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("ipv4")), $NATCIDR)) {
                                                                                    ...
                                                                                    if (!$noLogin) {
                                                                                        ...
                                                                                        $newvm = ["newid" => (int) $getvmid, "description" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("ipv4")), "format" => $clone_type, "full" => 1, "name" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("hostname")), "pool" => Input::get("poolid"), "storage" => Input::get("storage_location")];
                                                                                        $clonevm = $db->get("vncp_kvm_templates", ["id", "=", _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("ostemplate"))])->first();
                                                                                        ...
                                                                                        if (!$createkvm) {
                                                                                            ...
                                                                                            $db->insert("vncp_pending_clone", ["node" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("node")), "upid" => $createkvm, "hb_account_id" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("hb_account_id")), "data" => json_encode(["vmid" => $getvmid, "cores" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("cpucores")), "cpu" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("cputype")), "memory" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("ram")), "cipassword" => _obfuscated_0D1A2A3B0501041909311C2D0A3D2A1D290304395C0A01_($cipassword), "storage_size" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("storage_size")), "cvmtype" => $clonevm->type, "gateway" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("ipv4_gateway")), "ip" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("ipv4")), "netmask" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("ipv4_netmask")), "portspeed" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("portspeed")), "setmacaddress" => strtoupper(_obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("setmacaddress"))), "vlantag" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("setvlantag"))])]);
                                                                                            $allow_backups = _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_($db->get("vncp_settings", ["item", "=", "enable_backups"])->first()->value);
                                                                                            $abvalue = -1;
                                                                                            if ($allow_backups == "true") {
                                                                                                $abvalue = 1;
                                                                                            ...
                                                                                            $db->insert("vncp_kvm_ct", ["user_id" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("userid")), "node" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("node")), "os" => $clonevm->friendly_name, "hb_account_id" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("hb_account_id")), "pool_id" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("poolid")), "pool_password" => _obfuscated_0D1A2A3B0501041909311C2D0A3D2A1D290304395C0A01_($plaintext_password), "ip" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("ipv4")), "suspended" => 0, "allow_backups" => $abvalue, "fw_enabled_net0" => 0, "fw_enabled_net1" => 0, "has_net1" => 0, "onboot" => 0, "cloud_account_id" => 0, "cloud_hostname" => "", "from_template" => 1]);
                                                                                            $db->insert("vncp_ct_backups", ["userid" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("userid")), "hb_account_id" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("hb_account_id")), "backuplimit" => -1]);
                                                                                            $today = new DateTime();
                                                                                            $today->add(new DateInterval("P30D"));
                                                                                            $reset_date = $today->format("Y-m-d 00:00:00");
                                        ...
                                        if (Input::exists() && Input::get("action") == "lxctemp" && Input::get("form_name") == "new_lxc_template") {
                                            ...
                                            if (Input::exists() && Input::get("action") == "lxctemp" && Input::get("form_name") == "import_lxc_template") {
                                                ...
                                                for ($i = 0; $i < count($_POST["field"]); $i++) {
                                                    $temp_fname = _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(trim($_POST["field"][$i]["fname"]));
                                                    $temp_volid = _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(trim($_POST["field"][$i]["volid"]));
                                                            ...
                                                            if (Input::exists() && Input::get("action") == "kvmiso" && Input::get("form_name") == "import_kvm_iso") {
                                                                ...
                                                                if (Input::exists() && Input::get("action") == "tuntap") {
                                                                    if (Token::check(Input::get("token"))) {
                                                                        ...
                                                                        if ($validation->passed()) {
                                                                            $checkExists = $db->get("vncp_nodes", ["name", "=", _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("tuntapnode"))])->all();
                                                                            if (count($checkExists) == 1) {
                                                                                $db->insert("vncp_tuntap", ["node" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("tuntapnode")), "password" => _obfuscated_0D1A2A3B0501041909311C2D0A3D2A1D290304395C0A01_(_obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("rpassword"))), "port" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("sshport"))]);
                                                                        ...
                                                                        if (Input::exists() && Input::get("action") == "cloud" && Input::get("whatform") == "createcloud") {
                                                                            ...
                                                                            if (Input::exists() && Input::get("action") == "lxckvmprops") {
                                                                                if (Token::check(Input::get("token"))) {
                                                                                    ...
                                                                                    if ($validation->passed()) {
                                                                                        $verifyuid = $db->get("vncp_users", ["id", "=", _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("userid"))])->all();
                                                                                        if (count($verifyuid) != 1) {
                                                                                            $errors = "User ID does not exist.";
                                                                                        } else {
                                                                                            $verifynode = $db->get("vncp_nodes", ["name", "=", _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("vmnode"))])->all();
                                                                                            if (count($verifynode) != 1) {
                                                                                                $errors = "Node name does not exist.";
                                                                                            } else {
                                                                                                $verifyoldip = $db->get("vncp_dhcp", ["ip", "=", _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("vmip_old"))])->all();
                                                                                                if (count($verifyoldip) != 1) {
                                                                                                    ...
                                                                                                    if (!$verifypoolpw) {
                                                                                                        ...
                                                                                                        $lxccheck = $db->get("vncp_lxc_ct", ["hb_account_id", "=", _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("hbaccountid"))])->all();
                                                                                                        if (count($lxccheck) != 1) {
                                                                                                            $db->updatevm_aid("vncp_kvm_ct", _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("hbaccountid")), ["user_id" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("userid")), "node" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("vmnode")), "os" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("vmos")), "ip" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("vmip")), "allow_backups" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("vm_backups"))]);
                                                                                                            $db->updatevm_aid("vncp_ct_backups", _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("hbaccountid")), ["backuplimit" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("vm_backup_override"))]);
                                                                                                            if (Input::get("vmip") != Input::get("vmip_old")) {
                                                                                                                $db->updatevm_aid("vncp_ipv4_pool", _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("hbaccountid")), ["user_id" => 0, "hb_account_id" => 0, "available" => 1]);
                                                                                                                $db->update_address("vncp_ipv4_pool", _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("vmip")), ["user_id" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("userid")), "hb_account_id" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("hbaccountid")), "available" => 0]);
                                                                                                            } else {
                                                                                                                $db->updatevm_aid("vncp_ipv4_pool", _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("hbaccountid")), ["user_id" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("userid"))]);
                                                                                                            }
                                                                                                            if ($dopoolpw) {
                                                                                                                $db->updatevm_aid("vncp_kvm_ct", _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("hbaccountid")), ["pool_password" => _obfuscated_0D1A2A3B0501041909311C2D0A3D2A1D290304395C0A01_(_obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("vm_poolpw")))]);
                                                                                                            }
                                                                                                            $db->updatevm_aid("vncp_ipv6_assignment", _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("hbaccountid")), ["user_id" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("userid"))]);
                                                                                                            $db->updatevm_aid("vncp_natforwarding", _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("hbaccountid")), ["user_id" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("userid"))]);
                                                                                                            $db->updatevm_aid("vncp_private_pool", _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("hbaccountid")), ["user_id" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("userid"))]);
                                                                                                            $db->updatevm_aid("vncp_secondary_ips", _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("hbaccountid")), ["user_id" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("userid"))]);
                                                                                                            $db->update_dhcp("vncp_dhcp", Input::get("vmip_old"), ["gateway" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("vmip_gateway")), "netmask" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("vmip_netmask")), "ip" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("vmip"))]);
                                                                                                            ...
                                                                                                            $db->updatevm_aid("vncp_lxc_ct", _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("hbaccountid")), ["user_id" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("userid")), "node" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("vmnode")), "os" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("vmos")), "ip" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("vmip")), "allow_backups" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("vm_backups"))]);
                                                                                                            $db->updatevm_aid("vncp_ct_backups", _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("hbaccountid")), ["backuplimit" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("vm_backup_override"))]);
                                                                                                            if (Input::get("vmip") != Input::get("vmip_old")) {
                                                                                                                $db->updatevm_aid("vncp_ipv4_pool", _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("hbaccountid")), ["user_id" => 0, "hb_account_id" => 0, "available" => 1]);
                                                                                                                $db->update_address("vncp_ipv4_pool", _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("vmip")), ["user_id" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("userid")), "hb_account_id" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("hbaccountid")), "available" => 0]);
                                                                                                            ...
                                                                                                            if ($dopoolpw) {
                                                                                                                $db->updatevm_aid("vncp_lxc_ct", _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("hbaccountid")), ["pool_password" => _obfuscated_0D1A2A3B0501041909311C2D0A3D2A1D290304395C0A01_(_obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("vm_poolpw")))]);
                                                                                                            }
                                                                                                            $db->updatevm_aid("vncp_ipv6_assignment", _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("hbaccountid")), ["user_id" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("userid"))]);
                                                                                                            $db->updatevm_aid("vncp_natforwarding", _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("hbaccountid")), ["user_id" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("userid"))]);
                                                                                                            $db->updatevm_aid("vncp_private_pool", _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("hbaccountid")), ["user_id" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("userid"))]);
                                                                                                            $db->updatevm_aid("vncp_secondary_ips", _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("hbaccountid")), ["user_id" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("userid"))]);
                                                                                                            $db->update_dhcp("vncp_dhcp", _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("vmip_old")), ["gateway" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("vmip_gateway")), "netmask" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("vmip_netmask")), "ip" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("vmip"))]);
                                                                                                        }
                                                                                                        if ($dopoolpw) {
                                                                                                            ...
                                                                                                            if (!$noLogin) {
                                                                                                                $updatepw = $pxAPI->put("/access/password", ["userid" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("vm_poolname")) . "@pve", "password" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("vm_poolpw"))]);
                                                                                                                sleep(1);
                                                                                                                $log->log("Updated VPS pool password of account ID " . _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("hbaccountid")), "admin", 0, $user->data()->username, $_SERVER["REMOTE_ADDR"]);
                                                                                                            }
                                                                                                        }
                                                                                                        $log->log("Updated VPS properties of account ID " . _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("hbaccountid")), "admin", 0, $user->data()->username, $_SERVER["REMOTE_ADDR"]);
                                                                                                        $editedSuccess = true;
                                                                                                    }
                                                                                                }
                                                                                            }
                                                                                    ...
                                                                                    if (Token::check(Input::get("token"))) {
                                                                                        ...
                                                                                        if ($validation->passed()) {
                                                                                            if (Input::get("userid") != "default") {
                                                                                                $verifyuser = $db->get("vncp_users", ["id", "=", _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("userid"))])->all();
                                                                                                ...
                                                                                                if ($validation->passed()) {
                                                                                                    ...
                                                                                                    if (count($privnodes) <= 0) {
                                                                                                        ...
                                                                                                        if (!$exists) {
                                                                                                            ...
                                                                                                            $db->insert("vncp_ipv4_pool", ["user_id" => 0, "hb_account_id" => 0, "address" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("ipaddress")), "available" => 1, "netmask" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("ipnetmask")), "nodes" => implode(";", $privnodes), "gateway" => _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("ipgateway"))]);
...
$appname = _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_($db->get("vncp_settings", ["item", "=", "app_name"])->first()->value);
echo $appname;
...
$action = _obfuscated_0D272F243C163F30393C2D05363D2D2B39015C40260C32_(Input::get("action"));
switch ($action) {
    case "users":
